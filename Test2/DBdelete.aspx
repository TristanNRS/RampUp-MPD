<%@ Page Title="Delete" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DBdelete.aspx.cs" Inherits="Test2.DBdelete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="authorizationPanel" runat="server">
        ...
        <div class="row mt-4">
            <div class="col">
                <asp:GridView ID="GridView1" runat="server" OnRowDeleting="GridView1_RowDeleting" AutoGenerateDeleteButton="true" EnableViewState="false" GridLines="None"
